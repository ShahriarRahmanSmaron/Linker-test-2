...
export const HeroSection: React.FC = () => {
    ...
    return (
        <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white dark:bg-gradient-to-br dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left z-10">
                        <Reveal>
                            <div className="font-heading inline-flex items-center px-2.5 sm:px-3 py-1 rounded-full bg-primary-100 dark:bg-primary-500/30 text-primary-700 dark:text-white text-[10px] sm:text-xs font-semibold tracking-wide mb-4 sm:mb-6 border border-primary-300 dark:border-primary-400/40 shadow-sm uppercase">
                                <span className="flex h-1.5 sm:h-2 w-1.5 sm:w-2 rounded-full bg-primary-500 dark:bg-primary-300 mr-1.5 sm:mr-2"></span>
                        ...
                        <Reveal>
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
                                <button onClick={() => navigate('/login?role=buyer')} className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-primary-500 text-white rounded-full font-bold shadow-lg shadow-primary-500/30 hover:bg-primary-400 transition-colors duration-150 flex items-center justify-center touch-manipulation">
                                    Explore Fabrics
                                    <ArrowRight size={18} className="ml-2" />
                                </button>
                                <button onClick={() => navigate('/login?role=manufacturer')} className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white border border-neutral-300 dark:border-neutral-600 rounded-full font-semibold hover:border-neutral-400 dark:hover:border-neutral-500 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-[background-color,border-color] duration-150 shadow-sm touch-manipulation">
                    ...
                    <div className="relative z-0 mt-10 lg:mt-0">
                        <Reveal>
                            {/* Decorative background blobs - light/dark theme - paused on scroll for performance */}
                            <div className="absolute -top-10 -right-10 w-80 h-80 bg-accent-500/10 dark:bg-accent-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 motion-reduce:animate-none" style={{ willChange: 'transform' }}></div>
                            <div className="absolute -bottom-10 -left-10 w-80 h-80 bg-primary-500/10 dark:bg-primary-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 motion-reduce:animate-none" style={{ willChange: 'transform' }}></div>

                            {/* The "App" Window - Glassmorphism with light/dark theme */}
                            <div className="relative bg-white/95 dark:bg-neutral-800/90 rounded-2xl shadow-2xl border border-neutral-200 dark:border-white/20 overflow-hidden transform rotate-y-12 rotate-x-6 hover:rotate-0 transition-transform duration-700 ease-out ring-1 ring-neutral-200 dark:ring-white/20">
                                ...
                                <div className="flex h-[280px] sm:h-[350px] md:h-[400px]">
                                    ...
                                    <div className="w-16 sm:w-32 md:w-48 bg-neutral-50 dark:bg-neutral-800/80 border-r border-neutral-200 dark:border-white/20 p-2 sm:p-4 hidden sm:block">
                                ...
                                {/* Floating Badge - removed infinite animation for performance */}
                                <div className="absolute bottom-4 sm:bottom-6 right-4 sm:right-6 bg-primary-500 dark:bg-primary-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg shadow-xl flex items-center text-xs sm:text-sm font-bold border border-primary-400 dark:border-primary-400/30">
