        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <Reveal>
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-primary-50 dark:from-primary-900/20 to-accent-50 dark:to-accent-900/20 rounded-full blur-3xl opacity-40"></div>
          ...
          <Reveal delay={200}>
            <div className="grid gap-3 sm:gap-4">
              {VALUE_PROP_HIGHLIGHTS.map((highlight, index) => (
                <div key={index} className="flex items-center p-3 sm:p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl border border-neutral-100 dark:border-neutral-700 shadow-sm hover:shadow-md hover:border-primary-100 dark:hover:border-primary-800 transition-all duration-200">
                  ...
                  <span className="text-base sm:text-lg font-medium text-neutral-800 dark:text-neutral-200">{highlight}</span>
                </div>
              ))}
            </div>
          </Reveal>
