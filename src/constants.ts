...
export const FAQS: FAQItem[] = [
  {
    ...
    answer: 'No. Fab-Ai is fully browser-based and optimized for laptop, desktop, and tablet usage.'
  },
  {
...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: 't1',
    quote: "Fab-Ai cut our sourcing time from 6 weeks to 3 days. The techpack auto-generation alone saved us hundreds of hours per season.",
  ...
  {
    id: 't3',
    quote: "We found sustainable suppliers we never knew existed. Fab-Ai's filters for certifications and transparency data are unmatched.",
